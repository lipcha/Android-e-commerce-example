...
public class RxExecutorImpl implements RxExecutor {
    ...
    public <T> Disposable execute(Observable<T> request, Consumer<T> onSuccessCallback) {
        return execute(request, onSuccessCallback, null);
    }

    @Override
    public <T> Disposable execute(Observable<T> request, Consumer<T> onSuccessCallback, Consumer<Throwable> errorCallback) {
        return execute(request, onSuccessCallback, errorCallback, null);
    }
